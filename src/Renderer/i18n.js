...
const LANG = {
  en: {
    ...
    min_today:            'min today',
    no_cardio_sessions:   'No cardio sessions yet',
    cardio_activity_ph:   'Activity (Run, Walk, Swim…)',
    cardio_duration_ph:   'Duration (e.g. 30 min)',
    calories:             'Calories',
    calories_logged:      'Calories logged',
    no_calorie_sessions:  'No calories logged yet',
    calorie_meal_ph:      'Meal / description',
    calorie_amount_ph:    'kcal',
    box_theme:            'Background',
    app_theme:            'Background',
    show_reflection:      'Daily Reflection',
  ...
  ar: {
    ...
    cardio_logged:        'تم تسجيل الكارديو',
    min_today:            'دقيقة اليوم',
    no_cardio_sessions:   'لا توجد جلسات كارديو بعد',
    cardio_activity_ph:   'النشاط (ركض، مشي، سباحة…)',
    cardio_duration_ph:   'المدة (مثال: 30 دقيقة)',
    calories:             'السعرات',
    calories_logged:      'تم تسجيل السعرات',
    no_calorie_sessions:  'لم يتم تسجيل سعرات بعد',
    calorie_meal_ph:      'وجبة / وصف',
    calorie_amount_ph:    'سعرة حرارية',
    box_theme:            'الخلفية',
    app_theme:            'الخلفية',
    show_reflection:      'التأمل اليومي',
